...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="mb-28 max-w-[50rem] text-center sm:m-0 scroll-mt-[100rem]"
    >
      ...
      >
        ...
        <a
          className="bg-white text-black p-4 flex items-center gap-2 rounded-full focus:scale-110 hover:scale-110  active:scale-105 transition cursor-pointer border border-black/10 "
